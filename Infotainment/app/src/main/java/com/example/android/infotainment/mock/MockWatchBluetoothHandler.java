...
public class MockWatchBluetoothHandler {
    ...
    public MockWatchBluetoothHandler(BluetoothSocket socket, Context mainContext, DataParser dataParser){
        ...
        try {
            ...
            //InputStream is = AM.open("cruising2.csv");
            //InputStream is = AM.open("slowRightTurn.csv");
            //InputStream is = AM.open("lightRightTurn.csv");
            //InputStream is = AM.open("CombinedAccelBrake.csv");
            //InputStream is = AM.open("HRTest.csv");
