...
package com.example.android.infotainment.backend.FastDTW.dtw;
...
import com.example.android.infotainment.backend.FastDTW.matrix.ColMajorCell;
...
public class DTW
{
   ...
   public static double calcWarpCost(WarpPath path, TimeSeries tsI, TimeSeries tsJ, DistanceFunction distFn)
   {
      ...
      {
         final com.example.android.infotainment.backend.FastDTW.matrix.ColMajorCell currWarp = path.get(p);
